function [x_da,xp_da] = DAmethod_line(dpoffset,Settings)
%{
Method to compute dynamic aperture using a line search 
...
A_da = zeros(1,nlines);
k = 1;
while ~isempty(linesBeingChecked) && k <= numel(Avalues)
